...
//$type = 1, 2, 3, 4, 5
$purchaseType = substr((file_get_contents("php://input")), -1);

//$purchaseType = $_POST['buyValueToSend'];
$name = $purchaseType;
switch ($purchaseType) {
  case "1":
    $name = 'Reset limits';
    $description = "These limits were put in place for a REASON, you DARE DEFY ME?";
    $price = "1";
    break;
  case "2":
    $name = 'One Thousand Dollars';
    $description = "What! No, you can't do that - that's cheating!";
    $price = "2";
    break;
  case "4":
    $name = 'Ten Thousand Dollars';
    $description = 'Stop it! Stop cheating!';
    $price = "4";
    break;
  case "8":
    $name = 'One Hundred Thousand Dollars';
    $description = "NO! I said you can't do that!";
    $price = "8";
    break;
  case "0":
    $name = 'One Million Dollars';
    $description = "NO - you dare skip on the popping of my bubbles? You can't to that!";
    $price = "10";
    break;
  default:
}
...
//echo "hello";
$appMsg = file_get_contents("php://input");
if ($appMsg[0] == "b") {
    $payload = array(
    ...
    $bubbleToken = JWT::encode($payload, $sellerSecret);

    //Send bubbleToken to the app
    echo json_encode($bubbleToken);
    //echo $name;
} else {
    echo "hello world!";
}
...
// =================== V2 =======================
/*
$issuerId = "11647741613972529059";
$secretKey = "c4XarvRPriBAkX6IYZp2Cw";
