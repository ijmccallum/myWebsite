...
<ol class="breadcrumb">
  ...
  <li class="active">Database systems</li>
</ol>
...
<div class="list-group">
  <a href="guides/webservers.php" class="list-group-item">MySQL</a>
  <a href="guides/frameworks.php" class="list-group-item">MongoDB</a>
  <a href="guides/cms.php" class="list-group-item">...</a>
</div>
