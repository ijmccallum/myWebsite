...
<div class="row" style="text-align:center;">
    <div class="col-md-12">
        ...
        <div class="iconBox">
            <img src="pics/HTML5-logo.png" width="50" height="50">
            <p>HTML5</p>
        </div>
        <div class="iconBox">
            <img src="pics/css3-logo.png" width="50" height="50">
            <p>CSS3</p>
        </div>
        <div class="iconBox">
...
<div class="row">
    <div class="col-md-6">
        <p>And a few more that I have worked on, usually in upkeep, updates, editing, general things really.</p>
        <code><a target="_blank" href="http://coiaandassociates.com/">www.coiaandassociates.com</a></code><br />
        <code><a target="_blank" href="http://www.drymenselfcatering.com/">www.drymenselfcatering.com</a></code><br />
        <code><a target="_blank" href="http://www.swarmonline.com/">www.swarmonline.com</a></code>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <p class="lead">
            My interest in code was sparked while working on the art and design for <a href="http://iainjmccallum.com/synergy.php">Synergy</a>, 
            and I couldn't be more glad that it happened!  I learnt by working through the whole of Stanford's online 'Programming methodology' cource and getting stuck into development for WordPress themes and plugins using simple HTML, CSS and PHP.  
            Web Design and Development became a part of my freelance work which led to my first job as a Designer/Developer with a Software Development company where I picked up a far more in-depth understanding of development and the many tools that go with it.
        	From then until now I have built and helped out with a number of projects, the list above shows some of the more interesting ones.
        </p>
        <hr />
    </div> 
</div> 
